...
** add current dir to INC everywhere
 push @INC, '.';
** Update Logeion LSJ
** Integrate Logeion L-S
...
Requires rewriting perseus_handler
possibly not worth it, as it may break parsing of hyphenated words.
