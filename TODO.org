...
** Remove stale HTTP cache when upgrading
** Window size is only remembered for first window
** Reinstate TLG word-list searching on user-defined subsets
** Think about a way to override font selection
