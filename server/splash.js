...
window.onload = function () {
    ...
    infoText['filters'] = '<h2 class="info-h2">Select subsets of texts</h2>' +
        ...
        '<p class="info-field"><center><input type="submit" name="go" value="Create and Manage Subsets" class="info-field"></center></p>';
    ...
    infoText['export'] = '<h2 class="info-h2">Export texts as XML</h2>' +
        ...
        '<p class="info-field"><center><input type="submit" name="go" value="Go to XML Export Page" class="info-field"></center></p><h1>Not implemented yet!</h1>';
